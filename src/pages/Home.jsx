  ...
  return (
    <>
        ...
        <div className="dark:bg-transparent">
          <div className="mx-auto flex flex-col items-center py-12 sm:py-24">
            <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
              <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-6xl text-center text-white dark:text-white font-black leading-10">
            ...
            <div className="flex w-11/12 md:w-8/12 xl:w-6/12">
              <div className="flex rounded-md w-full">
                <input
                  type="text"
                  name="q"
                  className="w-full p-3 rounded-md rounded-r-none border border-2 border-white placeholder-current dark:bg-neutral  dark:text-neutral dark:border-none"
                  placeholder="keyword"
                />
                <button className="inline-flex items-center gap-2 bg-secondary text-primary text-lg font-semibold py-3 px-6 rounded-r-md">
                  <span>Find</span>
                </button>
              </div>
            </div>
      ...
      <section className="flex items-center justify-center bg-white">
        <div class="  grid grid-cols-3 gap-10 rounded-xl p-10 text-sm">
          <div class="flex justify-center flex-col gap-2 p-10 bg-neutral-500 rounded-lg dark:border-gray-700">
            <div className="flex items-center justify-center w-[15%] bg-neutral-200 rounded-md p-3 text-secondary font-bold">
